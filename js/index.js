        ...
        `<a href="./goods.html?id=${card.id}" class="products-card">
              ...
              <div class="products-card__desc">
                <div class="products-card__desc-row">
                  ...
                  <div class="products-card__desc--badge">${card.time} минут</div>
                </div>
                <div class="products-card__desc-row">
                  <div class="products-card__desc-info">
                    ...
                    <div class="products-card__desc-info--price">От ${card.price} ₽</div>
...
console.log(container)
  const goodsArray = [
    ...
    {
      id: 4,
      title: 'Ясай маки стандарт 185 гv',
      ...
      container.insertAdjacentHTML(
        ...
        `<div class="products-card">
              ...
              <div class="products-card__desc">
                ...
                <div class="products-card__desc-row">
                  <p class="products-card__desc--text">${card.text}</p>
                </div>
                <div class="products-card__desc-row">
                  <div class="products-card__desc-controls">
                    <button class="btn btn-primary">
                      <div class="btn-title">В корзину</div>
                      <img src="./img/icons/shopping-cart-white.png" alt="cart">
                    </button>
